// 地主种子、道具与抽奖数据（从时光秘境文件迁出）
  // 种子属性
    ...
    "混沌瓶": { price: 1200000, color: "#4B0082", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得混沌雨词条（×28）（仅抽奖获得）" },
    "天道铃": { price: 1350000, color: "#FF1493", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得天道虹词条（×30）（仅抽奖获得）" },
    "创世喷雾": { price: 1500000, color: "#FF69B4", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得创世霞词条（×30）（仅抽奖获得）" },
    "永恒极光仪": { price: 1600000, color: "#00FA9A", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得永恒极光词条（×32）（仅抽奖获得）" },
    "仙霓壶": { price: 2800000, color: "#7FFFD4", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得仙霓词条（×50）（仅抽奖获得）" },
    "圣劫印": { price: 4500000, color: "#E6C200", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得圣劫词条（×100）（仅抽奖获得）" },
    "至道玉": { price: 8000000, color: "#FFF8DC", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得至道词条（×200）（仅抽奖获得）" },
    ...
    "超彩残卷": { price: 5000000, color: "#E0FFFF", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%随机获得一个尚未拥有的超彩天气词条（仅抽奖获得）" },
    /* —— 新增多量稀有道具（仅抽奖） —— */
    ...
    "诸天虹铃": { price: 1250000, color: "#E91E63", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得诸天虹（×29）（仅抽奖）" },
    "开天霞雾": { price: 1320000, color: "#FF8A65", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得开天霞（×30）（仅抽奖）" },
    "不灭极光仪": { price: 1450000, color: "#00BCD4", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得不灭极光（×31）（仅抽奖）" },
    "轮回霓珠": { price: 1550000, color: "#AB47BC", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得轮回霓（×32）（仅抽奖）" },
    "破界渡符": { price: 1650000, color: "#FF7043", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得破界渡（×33）（仅抽奖）" },
    "星河瀑瓶": { price: 1700000, color: "#5C6BC0", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得星河瀑（×34）（仅抽奖）" },
    "神域岚灯": { price: 1750000, color: "#26A69A", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得神域岚（×34）（仅抽奖）" },
    "道韵潮鼎": { price: 1850000, color: "#7E57C2", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得道韵潮（×35）（仅抽奖）" },
    "元初虹玉": { price: 1900000, color: "#EC407A", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得元初虹（×35）（仅抽奖）" },
    "瑶光劫壶": { price: 2600000, color: "#80DEEA", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得瑶光劫（×48）（仅抽奖）" },
    "紫微霓印": { price: 2700000, color: "#CE93D8", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得紫微霓（×52）（仅抽奖）" },
    "天河裂卷": { price: 2900000, color: "#90CAF9", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得天河裂（×55）（仅抽奖）" },
    "帝星陨杖": { price: 4200000, color: "#FFD54F", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得帝星陨（×85）（仅抽奖）" },
    "昊天劫印": { price: 4600000, color: "#FFB74D", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得昊天劫（×95）（仅抽奖）" },
    "太上极光仪": { price: 9000000, color: "#FFF59D", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得太上极光（×220）（仅抽奖）" },
    "月阙岚瓶": { price: 2750000, color: "#81D4FA", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得月阙岚（×54）（仅抽奖）" },
    "青霄霓印": { price: 2850000, color: "#80CBC4", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得青霄霓（×56）（仅抽奖）" },
    "灵泉劫壶": { price: 3000000, color: "#A5D6A7", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得灵泉劫（×62）（仅抽奖）" },
    "紫极罚符": { price: 4800000, color: "#B39DDB", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得紫极罚（×105）（仅抽奖）" },
    "穹苍陨杖": { price: 5200000, color: "#FFCC80", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得穹苍陨（×115）（仅抽奖）" },
    "天衡劫印": { price: 5600000, color: "#FFE082", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得天衡劫（×125）（仅抽奖）" },
    "混沌元珠": { price: 7200000, color: "#F8BBD0", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得混沌元（×165）（仅抽奖）" },
    "玄黄裂卷": { price: 8000000, color: "#FFE0B2", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得玄黄裂（×190）（仅抽奖）" },
    "无极霞玉": { price: 9500000, color: "#E1BEE7", refreshProbability: 0, lotteryOnly: true, description: "已有天气词条时，5%获得无极霞（×230）（仅抽奖）" },
    ...
    "天机罗盘": { price: 1100000, color: "#20B2AA", refreshProbability: 0, lotteryOnly: true, description: "15%获得一个尚未拥有的紫色及以上天气词条（仅抽奖获得）" }
        ...
        const LANDLORD_LOTTERY_ITEM_ROLL_TAGS = {
            ...
            "混沌瓶": { tag: "混沌雨", chance: 5 },
            "天道铃": { tag: "天道虹", chance: 5 },
            "创世喷雾": { tag: "创世霞", chance: 5 },
            "永恒极光仪": { tag: "永恒极光", chance: 5 },
            "仙霓壶": { tag: "仙霓", chance: 5 },
            "圣劫印": { tag: "圣劫", chance: 5 },
            "至道玉": { tag: "至道", chance: 5 },
            ...
            "诸天虹铃": { tag: "诸天虹", chance: 5 },
            "开天霞雾": { tag: "开天霞", chance: 5 },
            "不灭极光仪": { tag: "不灭极光", chance: 5 },
            "轮回霓珠": { tag: "轮回霓", chance: 5 },
            "破界渡符": { tag: "破界渡", chance: 5 },
            "星河瀑瓶": { tag: "星河瀑", chance: 5 },
            "神域岚灯": { tag: "神域岚", chance: 5 },
            "道韵潮鼎": { tag: "道韵潮", chance: 5 },
            "元初虹玉": { tag: "元初虹", chance: 5 },
            "瑶光劫壶": { tag: "瑶光劫", chance: 5 },
            "紫微霓印": { tag: "紫微霓", chance: 5 },
            "天河裂卷": { tag: "天河裂", chance: 5 },
            "帝星陨杖": { tag: "帝星陨", chance: 5 },
            "昊天劫印": { tag: "昊天劫", chance: 5 },
            "太上极光仪": { tag: "太上极光", chance: 5 },
            "月阙岚瓶": { tag: "月阙岚", chance: 5 },
            "青霄霓印": { tag: "青霄霓", chance: 5 },
            "灵泉劫壶": { tag: "灵泉劫", chance: 5 },
            "紫极罚符": { tag: "紫极罚", chance: 5 },
            "穹苍陨杖": { tag: "穹苍陨", chance: 5 },
            "天衡劫印": { tag: "天衡劫", chance: 5 },
            "混沌元珠": { tag: "混沌元", chance: 5 },
            "玄黄裂卷": { tag: "玄黄裂", chance: 5 },
            "无极霞玉": { tag: "无极霞", chance: 5 }
        };
// 突变倍率
        const mutationMultipliers = {
            // 灰色词条（天气加法公式为 1+Σ(m-1)，须 ≥2 才会真正加倍率）
            "潮湿": 2, "颤栗": 2, "生机": 2, "覆雪": 2,"腐烂": 2,
            "迷雾": 2, "灼热": 2, "沙尘": 2, "结霜": 2,"臭气": 2,
            // 绿色词条
            "银": 3, "落雷": 3, "冰冻": 3, "陶化": 3,
            // 蓝色词条
